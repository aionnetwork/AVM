...
public class BytecodeFeeScheduler {
    ...
    public void initialize() {
        feeScheduleMap = new HashMap<>() {{
            ...
            // Arithmetic
            put(Opcodes.IADD,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 1, 0));
            put(Opcodes.LADD,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 1, 0));
            put(Opcodes.FADD,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 1, 0));
            put(Opcodes.DADD,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 1, 0));
            put(Opcodes.ISUB,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 1, 0));
            put(Opcodes.LSUB,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 1, 0));
            put(Opcodes.FSUB,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 1, 0));
            put(Opcodes.DSUB,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 1, 0));
            put(Opcodes.IMUL,   new BytecodeFeeInfo(BytecodeEnergyLevels.LOW,     2, 1, 0));
            put(Opcodes.LMUL,   new BytecodeFeeInfo(BytecodeEnergyLevels.LOW,     2, 1, 0));
            put(Opcodes.FMUL,   new BytecodeFeeInfo(BytecodeEnergyLevels.LOW,     2, 1, 0));
            put(Opcodes.DMUL,   new BytecodeFeeInfo(BytecodeEnergyLevels.LOW,     2, 1, 0));
            put(Opcodes.IDIV,   new BytecodeFeeInfo(BytecodeEnergyLevels.LOW,     2, 1, 0));
            put(Opcodes.LDIV,   new BytecodeFeeInfo(BytecodeEnergyLevels.LOW,     2, 1, 0));
            put(Opcodes.FDIV,   new BytecodeFeeInfo(BytecodeEnergyLevels.LOW,     2, 1, 0));
            put(Opcodes.DDIV,   new BytecodeFeeInfo(BytecodeEnergyLevels.LOW,     2, 1, 0));
            put(Opcodes.IREM,   new BytecodeFeeInfo(BytecodeEnergyLevels.LOW,     2, 1, 0));
            put(Opcodes.LREM,   new BytecodeFeeInfo(BytecodeEnergyLevels.LOW,     2, 1, 0));
            put(Opcodes.FREM,   new BytecodeFeeInfo(BytecodeEnergyLevels.LOW,     2, 1, 0));
            put(Opcodes.DREM,   new BytecodeFeeInfo(BytecodeEnergyLevels.LOW,     2, 1, 0));
            put(Opcodes.INEG,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 1, 1, 0));
            put(Opcodes.LNEG,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 1, 1, 0));
            put(Opcodes.FNEG,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 1, 1, 0));
            put(Opcodes.DNEG,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 1, 1, 0));
            put(Opcodes.ISHL,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 1, 0));
            put(Opcodes.LSHL,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 1, 0));
            put(Opcodes.ISHR,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 1, 0));
            put(Opcodes.LSHR,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 1, 0));
            put(Opcodes.IUSHR,  new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 1, 0));
            put(Opcodes.LUSHR,  new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 1, 0));
            put(Opcodes.IAND,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 1, 0));
            put(Opcodes.LAND,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 1, 0));
            put(Opcodes.IOR,    new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 1, 0));
            put(Opcodes.LOR,    new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 1, 0));
            put(Opcodes.IXOR,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 1, 0));
            put(Opcodes.LXOR,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 1, 0));
            put(Opcodes.IINC,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 0, 0, 0));
            put(Opcodes.LCMP,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 1, 0));
            put(Opcodes.FCMPL,  new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 1, 0));
            put(Opcodes.FCMPG,  new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 1, 0));
            put(Opcodes.DCMPL,  new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 1, 0));
            put(Opcodes.DCMPG,  new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 1, 0));

            // Type Conversion
            put(Opcodes.I2L,    new BytecodeFeeInfo(BytecodeEnergyLevels.BASE,    1, 1, 0));
            put(Opcodes.I2F,    new BytecodeFeeInfo(BytecodeEnergyLevels.BASE,    1, 1, 0));
            put(Opcodes.I2D,    new BytecodeFeeInfo(BytecodeEnergyLevels.BASE,    1, 1, 0));
            put(Opcodes.L2I,    new BytecodeFeeInfo(BytecodeEnergyLevels.BASE,    1, 1, 0));
            put(Opcodes.L2F,    new BytecodeFeeInfo(BytecodeEnergyLevels.BASE,    1, 1, 0));
            put(Opcodes.L2D,    new BytecodeFeeInfo(BytecodeEnergyLevels.BASE,    1, 1, 0));
            put(Opcodes.F2I,    new BytecodeFeeInfo(BytecodeEnergyLevels.BASE,    1, 1, 0));
            put(Opcodes.F2L,    new BytecodeFeeInfo(BytecodeEnergyLevels.BASE,    1, 1, 0));
            put(Opcodes.F2D,    new BytecodeFeeInfo(BytecodeEnergyLevels.BASE,    1, 1, 0));
            put(Opcodes.D2I,    new BytecodeFeeInfo(BytecodeEnergyLevels.BASE,    1, 1, 0));
            put(Opcodes.D2L,    new BytecodeFeeInfo(BytecodeEnergyLevels.BASE,    1, 1, 0));
            put(Opcodes.D2F,    new BytecodeFeeInfo(BytecodeEnergyLevels.BASE,    1, 1, 0));
            put(Opcodes.I2B,    new BytecodeFeeInfo(BytecodeEnergyLevels.BASE,    1, 1, 0));
            put(Opcodes.I2C,    new BytecodeFeeInfo(BytecodeEnergyLevels.BASE,    1, 1, 0));
            put(Opcodes.I2S,    new BytecodeFeeInfo(BytecodeEnergyLevels.BASE,    1, 1, 0));

            // Object Creation and Manipulation
            put(Opcodes.GETSTATIC,      new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 0, 1, 0));
            put(Opcodes.PUTSTATIC,      new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 1, 0, 0));
            put(Opcodes.GETFIELD,       new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 0, 1, 0));
            put(Opcodes.PUTFIELD,       new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 0, 0));
            ...
            put(Opcodes.ARRAYLENGTH,    new BytecodeFeeInfo(BytecodeEnergyLevels.BASE, 1, 1, 0));
            put(Opcodes.CHECKCAST,      new BytecodeFeeInfo(BytecodeEnergyLevels.BASE, 1, 1, 0));
            put(Opcodes.INSTANCEOF,     new BytecodeFeeInfo(BytecodeEnergyLevels.BASE, 1, 1, 0));
            put(Opcodes.MULTIANEWARRAY, new BytecodeFeeInfo(BytecodeEnergyLevels.LOW,  5, 1, 0)); // delta of 5 is not accurate but bigger than alpha, so the value does not matter.

            // Operand Stack Management
            // Not in ASM Opcodes but Contants: LDC_W and LDC2_w -- visitor of LDC
            put(Opcodes.ICONST_M1,  new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 0, 1, 0));
            put(Opcodes.ICONST_0,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 0, 1, 0));
            put(Opcodes.ICONST_1,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 0, 1, 0));
            put(Opcodes.ICONST_2,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 0, 1, 0));
            put(Opcodes.ICONST_3,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 0, 1, 0));
            put(Opcodes.ICONST_4,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 0, 1, 0));
            put(Opcodes.ICONST_5,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 0, 1, 0));
            put(Opcodes.LCONST_0,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 0, 1, 0));
            put(Opcodes.LCONST_1,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 0, 1, 0));
            put(Opcodes.FCONST_0,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 0, 1, 0));
            put(Opcodes.FCONST_1,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 0, 1, 0));
            put(Opcodes.FCONST_2,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 0, 1, 0));
            put(Opcodes.DCONST_0,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 0, 1, 0));
            put(Opcodes.DCONST_1,   new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 0, 1, 0));
            put(Opcodes.BIPUSH,     new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 0, 1, 0));
            put(Opcodes.SIPUSH,     new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 0, 1, 0));
            put(Opcodes.LDC,        new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 0, 1, 0));
            put(Opcodes.POP,        new BytecodeFeeInfo(BytecodeEnergyLevels.BASE,    1, 0, 0));
            put(Opcodes.POP2,       new BytecodeFeeInfo(BytecodeEnergyLevels.BASE,    1, 0, 0));
            put(Opcodes.DUP,        new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 0, 1, 0));
            put(Opcodes.DUP_X1,     new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 3, 0));
            put(Opcodes.DUP_X2,     new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 3, 4, 0));
            put(Opcodes.DUP2,       new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 4, 0));
            put(Opcodes.DUP2_X1,    new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 3, 5, 0));
            put(Opcodes.DUP2_X2,    new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 4, 6, 0));
            put(Opcodes.SWAP,       new BytecodeFeeInfo(BytecodeEnergyLevels.VERYLOW, 2, 2, 0));
            ...
            // Throwing Exceptions
            put(Opcodes.ATHROW,    new BytecodeFeeInfo(BytecodeEnergyLevels.VERYHIGH, 5, 1, 0));
