...
public class AvmImplDeployAndRunTest {
    ...
    private static TransformedCodeStorage codeStorage;

    @BeforeClass
    public static void setupClass() {
        sharedClassLoader = new AvmSharedClassLoader(CommonGenerators.generateExceptionShadowsAndWrappers());
        codeStorage = new TransformedCodeStorage();
    }
    ...
    public AvmResult deployHelloWorld() {
        ...
        BlockchainRuntime rt = new SimpleRuntime(sender, address, energyLimit, null, codeStorage);
    ...
    public void testDeployWithMethodCall() {
        ...
        BlockchainRuntime rt = new SimpleRuntime(sender, address, energyLimit, txData, codeStorage);
        AvmImpl avm = new AvmImpl(sharedClassLoader);
        AvmResult result = avm.deploy(jar, rt);
    ...
    public void testDeployAndRun() {
        ...
        BlockchainRuntime rt = new SimpleRuntime(sender, deployResult.address.unwrap(), energyLimit, txData, codeStorage);
        AvmImpl avm = new AvmImpl(sharedClassLoader);
