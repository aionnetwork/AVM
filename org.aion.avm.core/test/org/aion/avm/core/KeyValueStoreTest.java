...
public class KeyValueStoreTest {
    ...
    public void testStorageBilling() {
        ...
        assertEquals(53392L + RuntimeMethodFeeSchedule.BlockchainRuntime_avm_resetStorage, deleteZeroCost);
        kernel.generateBlock();
        ...
        assertEquals(56719L + RuntimeMethodFeeSchedule.BlockchainRuntime_avm_setStorage + StorageFees.WRITE_PRICE_PER_BYTE * value.length, setStorageCost);
        kernel.generateBlock();
        ...
        assertEquals(56719L + RuntimeMethodFeeSchedule.BlockchainRuntime_avm_resetStorage + StorageFees.WRITE_PRICE_PER_BYTE * value.length, modifyStorageCost);
        ...
        assertEquals(50995 + RuntimeMethodFeeSchedule.BlockchainRuntime_avm_getStorage + StorageFees.READ_PRICE_PER_BYTE * value.length, getStorageCost);
        kernel.generateBlock();
        ...
        assertEquals(53392L + RuntimeMethodFeeSchedule.BlockchainRuntime_avm_resetStorage - RuntimeMethodFeeSchedule.BlockchainRuntime_avm_deleteStorage_refund, deleteStorageCost);
        ...
        assertEquals(50995L + RuntimeMethodFeeSchedule.BlockchainRuntime_avm_getStorage, getZeroCost);
