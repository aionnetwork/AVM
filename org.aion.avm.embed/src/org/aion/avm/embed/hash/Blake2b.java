...
import static org.aion.avm.embed.hash.Blake2b.Engine.Assert.assertFail;
import static org.aion.avm.embed.hash.Blake2b.Engine.Assert.exclusiveLowerBound;
import static org.aion.avm.embed.hash.Blake2b.Engine.Assert.inclusiveLowerBound;
import static org.aion.avm.embed.hash.Blake2b.Engine.Assert.inclusiveUpperBound;
import static org.aion.avm.embed.hash.Blake2b.Engine.LittleEndian.readInt;
import static org.aion.avm.embed.hash.Blake2b.Engine.LittleEndian.readLong;
import static org.aion.avm.embed.hash.Blake2b.Engine.LittleEndian.writeInt;
import static org.aion.avm.embed.hash.Blake2b.Engine.LittleEndian.writeLong;
