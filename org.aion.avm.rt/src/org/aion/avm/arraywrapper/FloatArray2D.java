...
public class FloatArray2D extends ObjectArray {
    ...
    public IObject avm_clone() {
        IHelper.currentContractHelper.get().externalChargeEnergy(RuntimeMethodFeeSchedule.FloatArray2D_avm_clone + RuntimeMethodFeeSchedule.RT_METHOD_FEE_FACTOR * length());
        lazyLoad();
    ...
    public FloatArray2D(Object[] underlying) {
        IHelper.currentContractHelper.get().externalChargeEnergy(RuntimeMethodFeeSchedule.FloatArray2D_avm_constructor_2);
    ...
    public FloatArray2D(IDeserializer deserializer, IPersistenceToken persistenceToken) {
