...
public class ShortArray2D extends ObjectArray {
    ...
    public IObject avm_clone() {
        IHelper.currentContractHelper.get().externalChargeEnergy(RuntimeMethodFeeSchedule.ShortArray2D_avm_clone + RuntimeMethodFeeSchedule.RT_METHOD_FEE_FACTOR * length());
        lazyLoad();
    ...
    public ShortArray2D(IDeserializer deserializer, IPersistenceToken persistenceToken) {
