 ...
 * When we need to look up the wrapper for a given type, we will prepend "org.aion.avm.exceptionwrapper." to its qualified name.
 ...
 * -"org.aion.avm.exceptionwrapper.java.lang.*" - These are just temporary wrappers of the shadow objects which only exist to satisfy
