...
public class ABIStreamingEncoderTest {
    ...
    public void testBigIntegerEncodings() {
        ...
        byte[] encoded = encoder.encodeOneBigInteger(value).toBytes();
        byte[] expected = new byte[]{ABIToken.BIGINT, 1, 10};
        Assert.assertArrayEquals(expected, encoded);

        value = new BigInteger("10456787634565768768761787000");
        encoded = encoder.encodeOneBigInteger(value).toBytes();
        ...
        encoded = encoder.encodeOneBigInteger(new BigInteger(0, new byte[]{0}))
                .encodeOneBigInteger(new BigInteger(1, new byte[]{10}))
                .encodeOneBigInteger(new BigInteger(-1, new byte[]{8, 9})).toBytes();
        expected = new byte[]{ABIToken.BIGINT, 1, 0, ABIToken.BIGINT, 1, 10, ABIToken.BIGINT, 2, -9, -9};
        Assert.assertArrayEquals(expected, encoded);
    }
    ...
    public void bigIntegerArrayEncodings() {
        ...
        byte[] encoded = encoder.encodeOneBigIntegerArray(bigIntegers).toBytes();
        ...
        bigIntegers[1] = null;
        bigIntegers[2] = new BigInteger(-1, new byte[]{10, 11});
        encoded = encoder.encodeOneBigIntegerArray(bigIntegers).toBytes();
